		...
		return (<div className="row">
			...
			<form className="col-12 px-5">
				<div className="form-group">
					<label  className="text-gray-dark" for="comment-body">Example textarea:</label>
				...
				<div className="form-group">
					<label className="text-gray-dark" for="auther">Auther:</label>
					<input type="text" className="form-control" id="auther" name="auther" value={this.state.author} onChange={(e) => this.onChangeAuthor(e)}/>
				</div>
				<button type="submit" className="btn btn-primary" onClick={this.onChangeAddComment.bind(this)}>Submit</button>
			</form>
